...
class Trellis( Topo ):
    ...
    def __init__( self, *args, **kwargs ):
        ...
        # Spines
        s226 = self.addSwitch('s226', cls=ONOSBmv2Switch, deviceId='226', grpcport=55226, pipeconf=PIPECONF_ID, portcfg=True)
        s227 = self.addSwitch('s227', cls=ONOSBmv2Switch, deviceId='227', grpcport=55227, pipeconf=PIPECONF_ID, portcfg=True)

        # Leaves
        s204 = self.addSwitch('s204', cls=ONOSBmv2Switch, deviceId='204', grpcport=55204, pipeconf=PIPECONF_ID, portcfg=True)
        s205 = self.addSwitch('s205', cls=ONOSBmv2Switch, deviceId='205', grpcport=55205, pipeconf=PIPECONF_ID, portcfg=True)
